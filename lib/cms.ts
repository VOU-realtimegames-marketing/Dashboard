...
const genFakeAdminData = () => {
  ...
  return {
    ...
    total_user: randomInteger(300, 500),
    total_user_last_month: randomInteger(0, 300),
    total_branch: randomInteger(20, 50),
    total_branch_last_month: randomInteger(15, 20),
    total_earning: randomInteger(0, 0),
    total_earning_last_month: randomInteger(0, 0),
